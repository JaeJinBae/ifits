...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="information${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
	...
	$(".title > a").click(function(e){
		...
		var k=$("input[name='keyword']").val();
		var keyword = encodeURIComponent(k);
		location.href="informationRead${pageMaker.makeQuery(pageMaker.cri.page)}&searchType="+searchType+"&keyword="+keyword+"&bno="+bno;
	});
...
<body id="main">
	...
	<section>
		<div class="section_top">
			<img class="pc_ver" src="${pageContext.request.contextPath}/resources/images/sub_information_top.jpg">
			<img class="m_ver" src="${pageContext.request.contextPath}/resources/images/mobile_sub_information_top.jpg">
		</div>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									...
									<td class="title"><a href="${pageContext.request.contextPath}/informationRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
