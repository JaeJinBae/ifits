        ...
        $(".btnOK").click(function(){
			...
			$.ajax({
				...
				success:function(result){
					console.log(result);
					if(result=='ok'){
						location.href="${pageContext.request.contextPath}/partnershipRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno="+bno;
					}else{
						alert("비밀번호가 틀립니다.");
					}
				}
			...
			<div class="content">
				<div class="tableWrap">
					<div class="checkWrap">
						...
						비밀번호 <input type="password" class="pwinput"><button class="btnOK">확인</button>&nbsp;<a href="partnership${pageMaker.makeSearch(pageMaker.cri.page)}"><button>목록으로</button></a>
					</div>
				</div>
			</div><!-- content end -->
		</div><!-- contentWrap end -->
