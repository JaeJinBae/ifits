...
<body id="main">
	...
	<section>
		...
		<div class="contentWrap">
			...
			<div class="content">
				<div class="tableWrap">
					<form id="f1" method="post" action="partnershipRegister">
						<table>
							<tr>
						...
						<div class="btnWrap">
							...
							<a href="${pageContext.request.contextPath}/partnership${pageMaker.makeSearch(pageMaker.cri.page)}" class="cancelBtn"><button type="button">취소</button></a>
						</div>
					</form>
				</div><!-- tableWrap end -->
			</div><!-- content end -->
