...
<body id="main">
	...
	<section>
		...
		<div class="contentWrap">
			...
			<div class="content">
				<div class="tableWrap">
					<form id="f1" method="post" action="qnaUpdate${pageMaker.makeSearch(pageMaker.cri.page)}">
						...
						<div class="btnWrap">
							<a href="${pageContext.request.contextPath}/qna${pageMaker.makeSearch(pageMaker.cri.page)}" class="goListBtn"><button type="button">목록</button></a>
							<input type="submit" value="수정" class="submitBtn">
							<a href="${pageContext.request.contextPath}/qnaRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}" class="cancelBtn"><button type="button">취소</button></a>
						</div>
					</form>
				</div><!-- tableWrap end -->
			</div><!-- content end -->
