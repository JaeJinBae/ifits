...
<script type="text/javascript">
	$(function(){
        ...
        $("#searchBtn").click(function(){
    		...
    		location.href="adminFaq${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
    	});
	...
	<div class="contentWrap">
		...
		<div class="centerMenu"> 
			...
			<div class="tbl_board">
					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									<td>${item.bno}</td>
									<td class="title"><a href="adminFaqRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
				...
				<p class="registerBtn"><a href="adminFaqRegister${pageMaker.makeSearch(pageMaker.cri.page)}"><button>글쓰기</button></a></p>
				<div class="page">
					<ul>
