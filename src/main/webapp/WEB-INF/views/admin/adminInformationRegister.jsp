...
<body>
	...
	<div class="contentWrap">
		...
		<div class="centerMenu">
			...
			<form id="form1" method="post" action="adminInformationRegister">
				<div id="container">
					...
					<div class="btn">
						...
						<a href="${pageContext.request.contextPath}/admin/adminInformation"><button type="button">뒤로가기</button></a>
					</div>
				</div>
			</form>
		</div>
