...
<body>
	...
	<div class="contentWrap">
		...
		<div class="centerMenu">
			...
			<form id="form1" method="post" action="adminPartnershipReplyUpdate${pageMaker.makeSearch(pageMaker.cri.page)}">
				<div id="container">
					...
					<div class="btn">
						...
						<a href="${pageContext.request.contextPath}/admin/adminPartnershipRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${reply.bno}"><button type="button">뒤로가기</button></a>
					</div>
				</div>
			</form>
		</div><!-- centerMenu end -->
