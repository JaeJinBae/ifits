...
<body>
	...
	<div class="contentWrap">
		...
		<div class="centerMenu">
			...
			<form id="form1" method="post" action="adminReviewReplyUpdate${pageMaker.makeSearch(pageMaker.cri.page)}">
				<div id="container">
					...
					<div class="btn">
						...
						<a href="${pageContext.request.contextPath}/admin/adminReviewRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${reply.bno}"><button type="button">뒤로가기</button></a>
					</div>
				</div>
			</form>
		</div><!-- centerMenu end -->
